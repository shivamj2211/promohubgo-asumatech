...
CREATE TABLE "pincode_offices" (
    ...
    CONSTRAINT "pincode_offices_pkey" PRIMARY KEY ("pincode","officename")
);
...
-- CreateIndex
CREATE INDEX "pincode_offices_pincode_idx" ON "pincode_offices"("pincode");
...
-- AddForeignKey
ALTER TABLE "InfluencerMedia" ADD CONSTRAINT "InfluencerMedia_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BrandMedia" ADD CONSTRAINT "BrandMedia_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
