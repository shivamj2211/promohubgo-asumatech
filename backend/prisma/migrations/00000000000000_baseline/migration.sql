...
-- CreateEnum
CREATE TYPE "InfluencerMediaType" AS ENUM ('PROFILE', 'COVER');

-- CreateEnum
CREATE TYPE "BrandMediaType" AS ENUM ('PROFILE', 'COVER');
...
CREATE TABLE "InfluencerMedia" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "type" "InfluencerMediaType" NOT NULL,
    "url" TEXT NOT NULL,
    "sortOrder" INTEGER,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "pincode_offices" (
    ...
    CONSTRAINT "pincode_offices_pkey" PRIMARY KEY ("officename","pincode")
);
...
CREATE TABLE "brand_values" (
    ...
    CONSTRAINT "brand_values_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "influencer_values" (
    "id" BIGSERIAL NOT NULL,
    "key" TEXT NOT NULL,
    "value" TEXT NOT NULL,
    "label" TEXT,
    ...
    CONSTRAINT "influencer_values_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "idx_contact_requests_from_user" ON "contact_requests"("from_user_id", "created_at");

-- CreateIndex
CREATE INDEX "idx_contact_requests_to_user" ON "contact_requests"("to_user_id", "status", "created_at");

-- CreateIndex
CREATE UNIQUE INDEX "contact_threads_request_id_key" ON "contact_threads"("request_id");

-- CreateIndex
CREATE UNIQUE INDEX "contact_threads_pair_idx" ON "contact_threads"("user_a_id", "user_b_id");
...
-- CreateIndex
CREATE INDEX "InfluencerMedia_userId_idx" ON "InfluencerMedia"("userId");

-- CreateIndex
CREATE INDEX "BrandMedia_userId_idx" ON "BrandMedia"("userId");

-- CreateIndex
CREATE INDEX "pincode_offices_pincode_idx" ON "pincode_offices"("officename");

-- CreateIndex
CREATE INDEX "idx_brand_values_key_active" ON "brand_values"("key", "is_active", "sort_order");

-- CreateIndex
CREATE UNIQUE INDEX "brand_values_key_value_key" ON "brand_values"("key", "value");

-- CreateIndex
CREATE INDEX "idx_influencer_values_key_active" ON "influencer_values"("key", "is_active", "sort_order");

-- CreateIndex
CREATE UNIQUE INDEX "influencer_values_key_value_key" ON "influencer_values"("key", "value");
...
-- CreateIndex
CREATE UNIQUE INDEX "user_identities_user_id_provider_provider_user_id_key" ON "user_identities"("user_id", "provider", "provider_user_id");

-- CreateIndex
CREATE UNIQUE INDEX "username_history_old_username_unique" ON "username_history"("old_username");

-- CreateIndex
CREATE INDEX "username_history_user_id_changed_at_idx" ON "username_history"("user_id", "changed_at" DESC);
...
-- AddForeignKey
ALTER TABLE "contact_requests" ADD CONSTRAINT "contact_requests_from_user_id_fkey" FOREIGN KEY ("from_user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "contact_requests" ADD CONSTRAINT "contact_requests_to_user_id_fkey" FOREIGN KEY ("to_user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "contact_threads" ADD CONSTRAINT "contact_threads_request_id_fkey" FOREIGN KEY ("request_id") REFERENCES "contact_requests"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "contact_threads" ADD CONSTRAINT "contact_threads_user_a_id_fkey" FOREIGN KEY ("user_a_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "contact_threads" ADD CONSTRAINT "contact_threads_user_b_id_fkey" FOREIGN KEY ("user_b_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "contact_messages" ADD CONSTRAINT "contact_messages_sender_id_fkey" FOREIGN KEY ("sender_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "contact_messages" ADD CONSTRAINT "contact_messages_thread_id_fkey" FOREIGN KEY ("thread_id") REFERENCES "contact_threads"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "InfluencerProfile" ADD CONSTRAINT "InfluencerProfile_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InfluencerCategory" ADD CONSTRAINT "InfluencerCategory_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InfluencerSocial" ADD CONSTRAINT "InfluencerSocial_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BrandProfile" ADD CONSTRAINT "BrandProfile_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BrandCategory" ADD CONSTRAINT "BrandCategory_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BrandPlatform" ADD CONSTRAINT "BrandPlatform_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InfluencerMedia" ADD CONSTRAINT "InfluencerMedia_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BrandMedia" ADD CONSTRAINT "BrandMedia_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
