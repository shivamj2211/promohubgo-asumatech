...
const pageTitle = "FAQs | PromoHubGo";
const pageDescription = "Answers to common questions from brands and influencers.";

export const metadata: Metadata = {
  title: pageTitle,
  description: pageDescription,
  alternates: { canonical: "/support/faqs" },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "/support/faqs",
...
<BreadcrumbJsonLd
  items={[
    ...
    { name: "FAQs", url: `${siteUrl}/support/faqs` }
  ]}
/>
...
<main className="mx-auto w-full max-w-5xl px-4 py-10">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <p className="mt-2 text-sm text-slate-600 dark:text-zinc-300">Answers to common questions from brands and influencers.</p>
        ...
        <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-700 dark:text-zinc-300">
            <li>• How do brands contact influencers?</li>
            <li>• How is pricing decided?</li>
            <li>• How do I upgrade to premium?</li>
          </ul>
        </div>
      </main>
</div>
