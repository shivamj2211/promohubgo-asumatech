...
const pageTitle = "Resource Hub | PromoHubGo";
const pageDescription = "Free templates, tools, and guides to run better creator campaigns.";
...
<main className="mx-auto w-full max-w-5xl px-4 py-10">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          <h1 className="text-3xl font-extrabold tracking-tight">Resource Hub</h1>
          <p className="mt-2 text-sm text-slate-600 dark:text-zinc-300">Free templates, tools, and guides to run better creator campaigns.</p>
          <div className="mt-5 flex flex-wrap gap-2">
            ...
            <Link href="/tools/campaign-brief-template" className="inline-flex items-center justify-center rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700">
        ...
        <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-700 dark:text-zinc-300">
            <li>• Templates: briefs & contracts</li>
            <li>• Tools: pricing & engagement calculators</li>
            <li>• Guides for brands & creators</li>
          </ul>
        </div>
      </main>
</div>
