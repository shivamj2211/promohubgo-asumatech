...
const pageTitle = "TikTok Fake Follower Checker | PromoHubGo";
const pageDescription = "Identify suspicious growth and engagement patterns on TikTok.";

export const metadata: Metadata = {
  title: pageTitle,
  description: pageDescription,
  alternates: { canonical: "/tools/tiktok-fake-follower-checker" },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "/tools/tiktok-fake-follower-checker",
    images: [
      {
...
<BreadcrumbJsonLd
  items={[
    ...
    { name: "TikTok Fake Follower Checker", url: `${siteUrl}/tools/tiktok-fake-follower-checker` }
  ]}
/>
...
<main className="mx-auto w-full max-w-5xl px-4 py-10">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          <h1 className="text-3xl font-extrabold tracking-tight">TikTok Fake Follower Checker</h1>
          <p className="mt-2 text-sm text-slate-600 dark:text-zinc-300">Identify suspicious growth and engagement patterns on TikTok.</p>
        ...
        <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-700 dark:text-zinc-300">
            <li>• View-to-like ratio</li>
            <li>• Engagement consistency</li>
            <li>• Growth anomalies</li>
