...
const pageTitle = "Influencer Price Calculator | PromoHubGo";
const pageDescription = "Estimate fair pricing based on reach, engagement, and deliverables.";

export const metadata: Metadata = {
  title: pageTitle,
  description: pageDescription,
  alternates: { canonical: "/tools/influencer-price-calculator" },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "/tools/influencer-price-calculator",
    images: [
      {
...
<BreadcrumbJsonLd
  items={[
    ...
    { name: "Influencer Price Calculator", url: `${siteUrl}/tools/influencer-price-calculator` }
  ]}
/>
...
<main className="mx-auto w-full max-w-5xl px-4 py-10">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          <h1 className="text-3xl font-extrabold tracking-tight">Influencer Price Calculator</h1>
          <p className="mt-2 text-sm text-slate-600 dark:text-zinc-300">Estimate fair pricing based on reach, engagement, and deliverables.</p>
        ...
        <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-700 dark:text-zinc-300">
            <li>• Inputs: platform, followers/views, ER, deliverables</li>
            <li>• Outputs: suggested price range + add-ons</li>
          </ul>
        </div>
      </main>
</div>
