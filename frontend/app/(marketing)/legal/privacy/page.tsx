...
const pageTitle = "Privacy Policy | PromoHubGo";
const pageDescription = "How PromoHubGo collects, uses, and protects data.";
...
<BreadcrumbJsonLd
  items={[
    ...
    { name: "Privacy", url: `${siteUrl}/legal/privacy` }
  ]}
/>
...
<main className="mx-auto w-full max-w-5xl px-4 py-10">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <p className="mt-2 text-sm text-slate-600 dark:text-zinc-300">How PromoHubGo collects, uses, and protects data.</p>
          <div className="mt-5 flex flex-wrap gap-2">
            <Link href="/legal/security" className="inline-flex items-center justify-center rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700">
              Security
            </Link>
          </div>
        </div>
