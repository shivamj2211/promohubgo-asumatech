...
const pageTitle = "Security | PromoHubGo";
const pageDescription = "Account safety practices and reporting vulnerabilities.";
...
<BreadcrumbJsonLd
  items={[
    ...
    { name: "Security", url: `${siteUrl}/legal/security` }
  ]}
/>
...
<main className="mx-auto w-full max-w-5xl px-4 py-10">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <p className="mt-2 text-sm text-slate-600 dark:text-zinc-300">Account safety practices and reporting vulnerabilities.</p>
