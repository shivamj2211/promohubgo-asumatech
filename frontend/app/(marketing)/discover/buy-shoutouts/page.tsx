...
const pageTitle = "Buy Shoutouts | PromoHubGo";
const pageDescription = "Book shoutouts with clear deliverables, pricing, and timelines (coming soon).";

export const metadata: Metadata = {
  title: pageTitle,
  description: pageDescription,
  alternates: { canonical: "/discover/buy-shoutouts" },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "/discover/buy-shoutouts",
    images: [
      {
...
<BreadcrumbJsonLd
  items={[
    ...
    { name: "Buy Shoutouts", url: `${siteUrl}/discover/buy-shoutouts` }
  ]}
/>
...
<main className="mx-auto w-full max-w-5xl px-4 py-10">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          <h1 className="text-3xl font-extrabold tracking-tight">Buy Shoutouts</h1>
          <p className="mt-2 text-sm text-slate-600 dark:text-zinc-300">Book shoutouts with clear deliverables, pricing, and timelines (coming soon).</p>
        ...
        <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-700 dark:text-zinc-300">
            <li>• Story, Reel, Post options</li>
            <li>• Optional link add-ons</li>
