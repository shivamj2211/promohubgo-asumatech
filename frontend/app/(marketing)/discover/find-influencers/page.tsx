...
const pageTitle = "Find Influencers | PromoHubGo";
const pageDescription = "Discover creators by niche, platform, location, and budget.";

export const metadata: Metadata = {
  title: pageTitle,
  description: pageDescription,
  alternates: { canonical: "/discover/find-influencers" },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "/discover/find-influencers",
    images: [
      {
...
<BreadcrumbJsonLd
  items={[
    ...
    { name: "Find Influencers", url: `${siteUrl}/discover/find-influencers` }
  ]}
/>
...
<main className="mx-auto w-full max-w-5xl px-4 py-10">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          <h1 className="text-3xl font-extrabold tracking-tight">Find Influencers</h1>
          <p className="mt-2 text-sm text-slate-600 dark:text-zinc-300">Discover creators by niche, platform, location, and budget.</p>
          <div className="mt-5 flex flex-wrap gap-2">
            <Link href="/listings" className="inline-flex items-center justify-center rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700">
              Browse Listings
            </Link>
        ...
        <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-700 dark:text-zinc-300">
            <li>• Use filters to shortlist</li>
            <li>• Open profiles and contact</li>
            <li>• Track requests in Inbox</li>
          </ul>
        </div>
      </main>
</div>
