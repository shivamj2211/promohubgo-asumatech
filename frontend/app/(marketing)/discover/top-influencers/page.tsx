...
const pageTitle = "Top Influencers | PromoHubGo";
const pageDescription = "Curated lists of high-performing creators (coming soon).";

export const metadata: Metadata = {
  title: pageTitle,
  description: pageDescription,
  alternates: { canonical: "/discover/top-influencers" },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "/discover/top-influencers",
    images: [
      {
...
<BreadcrumbJsonLd
  items={[
    ...
    { name: "Top Influencers", url: `${siteUrl}/discover/top-influencers` }
  ]}
/>
...
<main className="mx-auto w-full max-w-5xl px-4 py-10">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          <h1 className="text-3xl font-extrabold tracking-tight">Top Influencers</h1>
          <p className="mt-2 text-sm text-slate-600 dark:text-zinc-300">Curated lists of high-performing creators (coming soon).</p>
        ...
        <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-700 dark:text-zinc-300">
            ...
            <li>• Best engagement by niche</li>
