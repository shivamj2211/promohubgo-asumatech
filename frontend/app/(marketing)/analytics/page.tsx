...
const pageTitle = "Analytics & Tracking | PromoHubGo";
const pageDescription = "Track campaigns from brief → delivery → performance.";
...
<BreadcrumbJsonLd
  items={[
    ...
    { name: "Analytics", url: `${siteUrl}/analytics` }
  ]}
/>
...
<main className="mx-auto w-full max-w-5xl px-4 py-10">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          <h1 className="text-3xl font-extrabold tracking-tight">Analytics & Tracking</h1>
          <p className="mt-2 text-sm text-slate-600 dark:text-zinc-300">Track campaigns from brief → delivery → performance.</p>
