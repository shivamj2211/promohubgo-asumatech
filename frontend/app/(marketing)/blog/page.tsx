...
const pageTitle = "Blog | PromoHubGo";
const pageDescription = "Guides and insights for influencer marketing, creators, and brands.";
...
<main className="mx-auto w-full max-w-5xl px-4 py-10">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <p className="mt-2 text-sm text-slate-600 dark:text-zinc-300">Guides and insights for influencer marketing, creators, and brands.</p>
          <div className="mt-5 flex flex-wrap gap-2">
            <Link href="/resources" className="inline-flex items-center justify-center rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700">
              Explore Resources
            </Link>
        ...
        <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-700 dark:text-zinc-300">
            ...
            <li>• Influencer pricing & negotiation</li>
            <li>• Creator portfolio building</li>
            <li>• Fake follower signals</li>
            <li>• Analytics & reporting basics</li>
          </ul>
        </div>
      </main>
</div>
